...
**On the aggregate total, the model does not beat the best naive rule.** 1 of the 4 naive rules that forecast purchases lands closer. Predicting that each customer keeps repeating at the rate of their last 91 days of calibration gives 21,585 (+9.7%). The 91-day window was chosen after an audit had reported 30, 61 and 91 days, not blind; it is the least favourable of those three to the rule. Across look-backs of 30 days +2.6%, 61 days +1.2%, 91 days +9.7%, 122 days +16.5%, 152 days +18.5%, 182 days +26.6%, 273 days +47.4%, **the rule beats the model only with a look-back of 91 days or less.** From 122 days on, the model's total is closer. The result is about the most recent months of behaviour, not about recent-rate rules in general.
